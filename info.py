...
# Bot information
SESSION = environ.get('SESSION', 'MovieBot')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002464253304')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pushkar21989:pushkar21989@cluster0.sbgcoun.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "pushkar21989)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'pushkar21989')
